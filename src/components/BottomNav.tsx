...
export default function BottomNav() {
  ...
  return (
    <>
      ...
      <nav className="fixed bottom-0 left-0 right-0 mx-auto w-full max-w-md glass z-50 pb-safe">
        <div className="flex justify-around items-center h-16">
          <Link href="/" className={`flex flex-col items-center justify-center w-full transition-colors btn-soft ${pathname === '/' ? 'text-primary' : 'text-foreground/40'}`}>
          ...
          <Link href="/community" className={`flex flex-col items-center justify-center w-full transition-colors btn-soft ${pathname === '/community' ? 'text-primary' : 'text-foreground/40'}`}>
            <svg width="24" height="24" viewBox="0 0 24 24" fill={pathname === '/community' ? "currentColor" : "none"} stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="mb-1">
              <circle cx="12" cy="12" r="10"></circle>
              <line x1="2" y1="12" x2="22" y2="12"></line>
              <path d="M12 2a15.3 15.3 0 0 1 4 10 15.3 15.3 0 0 1-4 10 15.3 15.3 0 0 1-4-10 15.3 15.3 0 0 1 4-10z"></path>
            </svg>
            <span className="text-[10px] font-bold">피치광장</span>
          </Link>
          <Link href="/chat" className={`relative flex flex-col items-center justify-center w-full transition-colors btn-soft ${pathname.includes('/chat') ? 'text-primary' : 'text-foreground/40'}`}>
          ...
          <Link href="/profile" className={`flex flex-col items-center justify-center w-full transition-colors btn-soft ${pathname === '/profile' ? 'text-primary' : 'text-foreground/40'}`}>
